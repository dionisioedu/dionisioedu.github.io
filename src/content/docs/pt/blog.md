---
title: Blog
description: 'Hub editorial com destaques do portal, leituras recentes e próximos conteúdos recomendados.'
---

# Blog

Esta página funciona como o hub editorial do portal: o lugar para descobrir o que vale ler agora e por onde continuar.
...
- [SportPulse.today](/pt/projects/sportpulse/): backend, performance e integração com serviços externos.
- [Amorfy](/pt/projects/amorfy/): produto interativo com questionário e experiência guiada.
- [Wheel Of List](/pt/projects/wheel-of-list/): app enxuto para estudar utilidade, animação e feedback.

## Como usar este hub

1. Escolha um artigo em destaque.
2. Vá para uma referência relacionada para consolidar a base.
3. Feche com um projeto real para conectar teoria e entrega.
