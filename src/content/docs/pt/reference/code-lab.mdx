---
title: Code Lab
description: Ambiente prático do portal para devs testarem lógica, dados e algoritmos direto no navegador.
---
...
Se você está estudando base, fechando lacuna ou revisando para entrevista, esta é a área prática do portal.
...
- revisar sintaxe sem sair do portal
