...
description: Roteiro direto para quem quer começar programação com base forte, sem perder tempo pulando de assunto em assunto.
---
...
1. [Tipos de Dados](/pt/reference/tipos-de-dados/)
...
1. abre [Tipos de Dados](/pt/reference/tipos-de-dados/)
2. passa por [Estruturas de Dados](/pt/reference/estruturas-de-dados/)
3. consolida com [Lógica de Programação](/pt/reference/logica-de-programacao/)
4. fecha com [Algoritmos](/pt/reference/algoritmos/)

Essa sequência resolve a maior parte da bagunça mental de quem está começando.

## Próximas ações

- Leia agora [Tipos de Dados](/pt/reference/tipos-de-dados/)
- Depois siga para [Estruturas de Dados](/pt/reference/estruturas-de-dados/)
- Quando terminar a base, use [Projetos](/pt/projects/) para aplicar
