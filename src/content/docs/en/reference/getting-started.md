...
description: A direct roadmap for learning programming with a strong foundation instead of jumping randomly from topic to topic.
---
...
1. [Data Types](/en/reference/tipos-de-dados/)
...
1. open [Data Types](/en/reference/tipos-de-dados/)
2. move to [Data Structures](/en/reference/estruturas-de-dados/)
3. consolidate with [Programming Logic](/en/reference/logica-de-programacao/)
4. finish with [Algorithms](/en/reference/algoritmos/)

That sequence solves most of the mental chaos beginners deal with.

## Next actions

- Read [Data Types](/en/reference/tipos-de-dados/) now
- Then continue to [Data Structures](/en/reference/estruturas-de-dados/)
- After the foundation, use [Projects](/en/projects/) to apply what you learned
